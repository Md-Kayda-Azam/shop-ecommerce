...
const WomensFashion = () => {
  ...
  const { womenFashions, womensFashionSkeleton, error } = useSelector(
    (state) => state.womensFashion
  );
        ...
        <div className="container">
          <div className="row">
            <div className="col">
              <Link to="/">
                <img
                  src="https://i.etsystatic.com/9677300/r/il/edb9a9/1988747599/il_fullxfull.1988747599_4ory.jpg"
                  alt=""
                />
              </Link>
            </div>
            ...
            <div className="row shop-area">
              ...
              {womenFashions &&
                womenFashions.map((data, index) => (
                  <div className="col-md-4 shop-item mb-5" key={index}>
                    <div className="card">
                      <Link to="/admin/product/allCategory/womensfashion/singlePage">
                        <img
                          style={{ height: "300px", objectFit: "cover" }}
                          className="card-img"
                          src={`http://localhost:5050/image/womensFashion/${data.photo}`}
                          alt=""
                        />
                      </Link>
                      ...
                      <div className="card-footer">
                        ...
                        <p>
                          Regular_Price : $ <del>{data.regular_price}</del>{" "}
                        </p>
                        <button
