...
import {
  womensFashionDeleteProduct,
  womensFashionSingleProduct,
} from "../../../../redux/womensFashion/action";
...
const WomensFashionFDB = () => {
  ...
  return (
    <>
      ...
      <SingleWomensFashion
        single={single}
        handleSingleHide={handleSingleHide}
      />
              ...
              <div className="row">
                <div className="card-body">
                  <div className="widget">
                    <Link to="/admin/product" className="btn btn-primary mb-3">
                      Back Dashboard
                    </Link>
                    <Link
                      to="/admin/product/allCategory"
                    ...
                    <ul className="list-group">
                      <li className="list-group-item">
                        <Link to="/admin/product/allCategory/womensfashion">
                          Women's Fashion
                        </Link>
                      </li>
                      <li className="list-group-item">
                        <Link to="/admin/product/allCategory/health">
                          Health
                        </Link>
                      </li>
                      <li className="list-group-item">
                        <Link to="/admin/product/allCategory/beauty">
                          Beauty
                        </Link>
                      </li>
                      <li className="list-group-item">
                        <Link to="/admin/product/allCategory/mansfashion">
                          Man's Fashion
                        </Link>
                      </li>
                      <li className="list-group-item">
                        <Link to="/admin/product/allCategory/electronics">
                          Electronic
                        </Link>
                      </li>
                      <li className="list-group-item">
                        <Link to="/admin/product/allCategory/kids">Kids</Link>
                      </li>
                    </ul>
                  </div>
                </div>
                    ...
                    {womenFashions &&
                      womenFashions.map((data, index) => (
                        <tr>
                          ...
                          <td>
                            <img
                              src={`/image/womensFashion/${data.photo}`}
                              alt=""
                            />
                          </td>
                          <td>
                            ...
                            <a className="text-warning m-3" href="#">
